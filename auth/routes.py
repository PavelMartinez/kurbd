...
"""
        Блупринтик делает возможным аутентификацию, чтобы ты как дикий человек не лез куда не надо
        start_auth - Собственно выдает начальную страничку аутентификации (ввод логина и пароля) и проверяет есть ли данный пользователь в бд
        define_user - Оно собственно и проверяет вроде как , есть ли в БД инфа по человечку.
"""