            ...
            for i in range(max_row):
                ...
                for j in range(max_cow):
                    c = {
                        ...
                        'flag': bool(free_or_not[counter][0]) or bool(str(prises[counter][1]) in curr_basket)
                    }

                    print(str(prises[counter][1]), bool(free_or_not[counter][0]))
...
def save_order():
    ...
    if flag == True:
        ...
        return render_template('error.html', error='При сохранении заказа произошла ошибка. Скорее всего, утеряно соединение с Базой Данных и Ваш заказ не был сохранен. Пожалуйста, попробуйте снова!')
